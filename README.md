This model is made on Random Forest Regression model. The data has columns like Transmission ,Selling Price ,Present price etc in which we have to predict the selling price.
